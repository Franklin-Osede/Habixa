...
import { GenerateDailyPlanUseCase, GenerateDailyPlanDto } from './application/generate-daily-plan.use-case';

@Controller('planning')
export class PlanningController {
  constructor(private readonly generateDailyPlanUseCase: GenerateDailyPlanUseCase) {}
